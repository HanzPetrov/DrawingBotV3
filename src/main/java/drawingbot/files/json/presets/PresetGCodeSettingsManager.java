...
public class PresetGCodeSettingsManager extends DefaultPresetManager<PresetGCodeSettings, GCodeSettings> {
    ...
    public void registerSettings() {
        ...
        registerSetting(GenericSetting.createBooleanSetting(GCodeSettings.class, "gcodeMirror", false, (settings, value) -> settings.gcodeMirror.set(value)).setGetter(settings -> settings.gcodeMirror.get()));
